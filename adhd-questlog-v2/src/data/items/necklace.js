...
export const NECKLACE_ITEMS = {
  // ── COMMON (5) ──────────────────────────────────────────
  necklace_basic_1: {
    id: 'necklace_basic_1', name: 'String of Effort', slot: 'necklace', rarity: 'common', icon: '📿', color: '#9E9BC0',
    stats: { resilience: 4 },
    flavor: 'Strung together from every small win.',
  },
  necklace_basic_2: {
    id: 'necklace_basic_2', name: 'Pendant of Purpose', slot: 'necklace', rarity: 'common', icon: '📿', color: '#9E9BC0',
    stats: { focus: 4 },
    flavor: "You have a reason. You just need to remember it.",
  },
  necklace_basic_3: {
    id: 'necklace_basic_3', name: 'Charm of Consistency', slot: 'necklace', rarity: 'common', icon: '📿', color: '#9E9BC0',
    stats: { attack: 3, resilience: 3 },
    flavor: 'Show up. Do the thing. Repeat.',
  },
  necklace_basic_4: {
    id: 'necklace_basic_4', name: 'Bead of Beginning', slot: 'necklace', rarity: 'common', icon: '📿', color: '#9E9BC0',
    stats: { speed: 0.05, focus: 3 },
    flavor: 'Every journey starts with a single bead. Or something.',
  },
  necklace_basic_5: {
    id: 'necklace_basic_5', name: 'Amulet of Mild Clarity', slot: 'necklace', rarity: 'common', icon: '📿', color: '#9E9BC0',
    stats: { focus: 6, resilience: 5 },
    flavor: "Mild clarity. Better than none.",
  },
  // ── UNCOMMON (4) ────────────────────────────────────────
  necklace_presence_1: {
    id: 'necklace_presence_1', name: 'Pendant of Presence', slot: 'necklace', rarity: 'uncommon', icon: '🌙', color: '#5CDD8B',
  ...
  necklace_urgency_1: {
    id: 'necklace_urgency_1', name: 'Necklace of Urgency', slot: 'necklace', rarity: 'uncommon', icon: '⏱', color: '#5CDD8B',
    stats: { speed: 0.15, attack: 8 },
    flavor: "The timer is always running. This helps you remember that.",
  },
  necklace_hyperfocus_1: {
    id: 'necklace_hyperfocus_1', name: 'Talisman of Hyperfocus', slot: 'necklace', rarity: 'uncommon', icon: '🔮', color: '#5CDD8B',
  ...
  necklace_fortune_1: {
    id: 'necklace_fortune_1', name: 'Pendant of Fortune', slot: 'necklace', rarity: 'uncommon', icon: '🍀', color: '#5CDD8B',
    stats: { critChance: 0.07, critDamage: 0.32 },
    flavor: 'Luck exists. You just have to complete enough tasks to find it.',
  },
  // ── RARE (3) ────────────────────────────────────────────
  necklace_resolve_1: {
    id: 'necklace_resolve_1', name: 'Amulet of Resolve', slot: 'necklace', rarity: 'rare', icon: '📿', color: '#EF5350',
  ...
  necklace_architect_1: {
    id: 'necklace_architect_1', name: 'Blueprint Locket', slot: 'necklace', rarity: 'rare', icon: '🗺', color: '#4FC3F7',
  ...
  necklace_storm_1: {
    id: 'necklace_storm_1', name: 'Eye of Calm', slot: 'necklace', rarity: 'rare', icon: '🌀', color: '#4FC3F7',
  ...
  // ── EPIC (2) ────────────────────────────────────────────
  necklace_void_1: {
    id: 'necklace_void_1', name: 'Void Heart', slot: 'necklace', rarity: 'epic', icon: '🖤', color: '#B39DDB',
  ...
  necklace_chronicler_1: {
    id: 'necklace_chronicler_1', name: 'Locket of the Chronicler', slot: 'necklace', rarity: 'epic', icon: '📖', color: '#B39DDB',
  ...
  // ── LEGENDARY (1) ───────────────────────────────────────
  necklace_legend_1: {
    id: 'necklace_legend_1', name: 'The Unfinished List', slot: 'necklace', rarity: 'legendary', icon: '🌠', color: '#F5C842',
