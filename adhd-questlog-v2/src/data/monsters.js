...
export const MONSTERS = [
  ...
  { id: 'slime_distract', name: 'Distracto Slime', tier: 1, loot_tier: 'tier1',
  ...
  { id: 'goblin_procrastin', name: 'Procrastin Goblin', tier: 1, loot_tier: 'tier1',
  ...
  { id: 'imp_notification', name: 'Notification Imp', tier: 1, loot_tier: 'tier1',
  ...
  { id: 'ghost_yesterday', name: 'Ghost of Yesterday\'s Plans', tier: 1, loot_tier: 'tier1',
    max_hp: 480, regen: 0, armor: 0, gold_drop: [9, 17], xp_drop: 13,
    sprite: '👻', color: '#E0E0E0',
    flavor: 'The list from last Tuesday haunts you.',
    loot_table: [] },

  { id: 'crab_sideways', name: 'Sideways Crab', tier: 1, loot_tier: 'tier1',
  ...
  { id: 'troll_overwhelm', name: 'Overwhelm Troll', tier: 2, loot_tier: 'tier2',
  ...
  { id: 'witch_avoidance', name: 'Avoidance Witch', tier: 2, loot_tier: 'tier2',
  ...
  { id: 'golem_routine', name: 'Broken Routine Golem', tier: 2, loot_tier: 'tier2',
  ...
  { id: 'harpy_comparison', name: 'Comparison Harpy', tier: 2, loot_tier: 'tier2',
  ...
  { id: 'wraith_deadline', name: 'Deadline Wraith', tier: 2, loot_tier: 'tier2',
  ...
  { id: 'mimic_taskswitch', name: 'Task-Switch Mimic', tier: 2, loot_tier: 'tier2',
  ...
  { id: 'hydra_tabs', name: 'Browser Tab Hydra', tier: 2, loot_tier: 'tier2',
  ...
  { id: 'vampire_energy', name: 'Energy Vampire', tier: 2, loot_tier: 'tier2',
  ...
  { id: 'scarecrow_perfectionism', name: 'Perfectionism Scarecrow', tier: 2, loot_tier: 'tier2',
  ...
  { id: 'golem_meeting', name: 'Unnecessary Meeting Golem', tier: 2, loot_tier: 'tier2',
  ...
  { id: 'dragon_backlog', name: 'Backlog Dragon', tier: 3, loot_tier: 'tier3',
  ...
  { id: 'lich_selfdoubt', name: 'Self-Doubt Lich', tier: 3, loot_tier: 'tier3',
  ...
  { id: 'colossus_inbox', name: 'Inbox Colossus', tier: 3, loot_tier: 'tier3',
  ...
  { id: 'werewolf_anxiety', name: 'Anxiety Werewolf', tier: 3, loot_tier: 'tier3',
  ...
  { id: 'titan_context', name: 'Context Switch Titan', tier: 3, loot_tier: 'tier3',
  ...
  { id: 'specter_impostor', name: 'Impostor Specter', tier: 3, loot_tier: 'tier3',
  ...
  { id: 'basilisk_stagnation', name: 'Stagnation Basilisk', tier: 3, loot_tier: 'tier3',
  ...
  { id: 'golem_resistance', name: 'Resistance Golem', tier: 3, loot_tier: 'tier3',
  ...
  { id: 'succubus_scroll', name: 'Doomscroll Succubus', tier: 3, loot_tier: 'tier3',
  ...
  { id: 'hydra_meetings', name: 'Recurring Meeting Hydra', tier: 3, loot_tier: 'tier3',
